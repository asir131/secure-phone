...
import { data, OtherMessage, other_person_message, user_message } from '../../../../constans';
...
const Message = () => {
  ...
  //   message: string;
  // }
  // const other_person_message: Message[] = [
  //   {
  //     "time": "12:46 PM",
  ...
  //   {
  //     "time": "12:56 PM",
  //     "message": "Your order #12345 has been shipped. Track your package at example.com/track."
  //   },
  //   {
  //     "time": "1:46 PM",
    ...
    <div className='z-10 text-white flex flex-col gap-[80px]'>
      ...
      <main className='z-20 flex justify-center items-center lg:mx-[160px] flex-col gap-[48px]'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-[18px] font-medium text-[#BEBEBE]'>View your messages securely in our intuitive dashboard interface.</p>
        </div>
        ...
        <div className='w-full z-10'>
          ...
          <div className='flex justify-between items-center sms_head'>
            ...
            <p className='flex items-center gap-2'>
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                  <path d="M10.5013 18.3334C15.1037 18.3334 18.8346 14.6025 18.8346 10.0001C18.8346 5.39771 15.1037 1.66675 10.5013 1.66675C5.89893 1.66675 2.16797 5.39771 2.16797 10.0001C2.16797 14.6025 5.89893 18.3334 10.5013 18.3334Z" stroke="white" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M10.5 5V10L13.8333 11.6667" stroke="white" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </span>
              <span>
                12:34 remaining
          ...
          <div className='flex gap-[14px] '>
            ...
            <div className='session_info flex-1 flex justify-start items-start flex-col max-w-[174px]'>
              <h1 className='text-[#E6E6E6] text-center text-[18px]'>Session Info</h1>
            ...
            <div className='flex-3 flex flex-col gap-6'>
              <div className='flex justify-between items-end py-6'>
                ...
                <div className='flex flex-col gap-[18px]'>
                  {other_person_message.map((message: OtherMessage, index: any) => {
                    return (
                      <div key={index}>
                        <div className="other_message">
                          <p className="message_time text-[#C8CACC] text-[12px]">{message.time}</p>
                          <p className="message_content text-[#E6E6E6] text-[12px]">{message.message}</p>
                        </div>
                      </div>
                    );
                  })}
                ...
                <div>
                  {
                    user_message.map((message: OtherMessage, index: number) => {
                      return <div key={index} className='use_message'>
                        <p className='text-[#C8CACC] text-[12px]'>{message.time}</p>
                        <p className='text-[#E6E6E6] text-[12px]'>{message.message}</p>
                      </div>
                    })
                  }
                </div>
              ...
              <div className='w-full'>
                <button className='buy_again_btn w-full text-[#0082F2] text-sm cursor-pointer'>Buy Again</button>
              </div>
            </div>
          </div>
        </div>
