        ...
        <div className='w-full z-10'>
          ...
          <div className='flex justify-between items-center sms_head'>
            ...
            <p className='flex items-center gap-2'>
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                  <path d="M10.5013 18.3334C15.1037 18.3334 18.8346 14.6025 18.8346 10.0001C18.8346 5.39771 15.1037 1.66675 10.5013 1.66675C5.89893 1.66675 2.16797 5.39771 2.16797 10.0001C2.16797 14.6025 5.89893 18.3334 10.5013 18.3334Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M10.5 5V10L13.8333 11.6667" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </span>
              <span>
                12:34 remaining
            ...
            <div className='flex-3 flex flex-col gap-6'>
              <div className='flex justify-between items-end py-6'>
                ...
                <div className='flex flex-col gap-[18px]'>
                  {other_person_message.map((message: OtherMessage) => {
                    return (
