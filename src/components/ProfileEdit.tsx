...
import people from "@/assets/people.png"; // 🧑 default image
...
const ProfileEdit = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4">
      <div className="p-[1px] bg-gradient-to-b from-[#0685F1] to-[#AAD8FF] rounded-2xl">
        <div className="w-full max-w-md bg-[#1C1C1C] p-8 rounded-2xl shadow-lg border border-[#2f2f2f]">
          {/* Header */}
          <div>
            <h2 className="text-2xl font-semibold text-[#E6E6E6] mb-2 font-['inter']">
              Edit Profile
            </h2>
          ...
          <div className="flex justify-center mb-8 relative">
            <div className="relative w-28 h-28">
              <Image
                src={profileImage || people}
                alt="Profile"
                width={112}
                height={112}
                className="w-28 h-28 rounded-full object-cover border-2 border-[#0082F2] my-5"
              />
              <label
          ...
          <form className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-[#2199FF] to-[#A7D6FF] hover:opacity-90 text-white py-2 px-6 rounded-lg font-semibold font-['inter'] transition-all duration-200"
            >
              Save & Change
            </button>
          </form>
          ...
          <Link
            href="/profile"
            className="block text-center text-[#2199FF] mt-4 hover:underline"
          >
            Back to Profile
          </Link>
        </div>
