...
const ProBuy = () => {
    ...
    const [min, setMin] = useState("30Min");
            ...
            <div className="w-full max-w-7/12">
                ...
                <form onSubmit={handlePayClick}>
                    <div className="flex flex-col gap-6">
                        ...
                        <button
                            type="submit"
                            className="w-full text-[#E6E6E6] border-[1px] border-blue-500/50 py-3 rounded-lg font-['inter'] text-xl font-medium transition hover:bg-blue-500/10"
                        >
                            Pay Now
                        </button>
                    </div>
